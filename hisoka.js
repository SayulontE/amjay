...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://i.postimg.cc/tJy8vFkv/Elaina-Menu.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⌕ 1jt Per Group via E-Walet 1 Month\n⌕ 1,5jt via pulsa 1 Month\n\n Premium Price Bot\n⌕ 200k per User 1 bulan\n\nPayment can be via Gopay/link aja/pulsa\n\nFor more details, you can chat with the owner\nhttps://wa.me/6285161426785 (Owner)\n\nDonate Lah biar bisa upgrade device` }, { quoted: m })
            }
            break
...
//────────────────────[ MAIN MENU HOOOOOOHHH ]────────────────────
             ...
             kon = await getBuffer(`https://i.postimg.cc/tJy8vFkv/Elaina-Menu.jpg`)
...
⌕ *Server Bot:* _Elaina - Server Powered by Safari_
⌕ *Tanggal:* _${moment.tz('Asia/Jakarta').format('DD/MM/YY')}_
⌕ *Waktu:* _${moment.tz('Asia/Jakarta').format('HH:mm:ss')}_             
⌕ *Bahasa Pemrograman:* _Java Script and nodejs_
⌕ *Versi Bot:* _Beta Version 2.5_
...
`
            ...
            case 'menuall': case 'allmenu': {
                buffer = await getBuffer(`https://i.postimg.cc/tJy8vFkv/Elaina-Menu.jpg`)
